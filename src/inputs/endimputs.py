                ...
                if event.key==pygame.K_RETURN:
                    ...
                    if cursorposition>0:
                        if cursorposition==1:
                            ...
                            database.scorelist[database.ind][0] = database.scorelist[database.ind][0][:cursorposition-1] + "_" + database.scorelist[database.ind][0][cursorposition:]
                        
                        cursorposition-=1
                else:
                    
                    if cursorposition<4:
                        database.scorelist[database.ind][0]= database.scorelist[database.ind][0][:cursorposition] + event.unicode + database.scorelist[database.ind][0][cursorposition+1:]
                        cursorposition+=1

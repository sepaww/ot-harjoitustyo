...
def draw_chr(screen, chrinfo, width, height):
    draw_highlight(screen, width,
                         height, 400, 300)       
    draw_txt(Stat.infofont, str(chrinfo[0]), Stat.txt_color, screen, width+40, height+10)
    draw_txt(Stat.smallfont, str(chrinfo[1]), Stat.txt_color, screen, width+10, height+60)
    draw_txt(Stat.infofont, str(f"Money: {chrinfo[3]}"), Stat.txt_color, screen, width+160, height+10)
    draw_txt(Stat.infofont, str(f"income: {chrinfo[4]}"), Stat.txt_color, screen, width+10, height+120)
    draw_txt(Stat.infofont, str(f"expenses: {chrinfo[5]}"), Stat.txt_color, screen, width+190, height+120)
    draw_txt(Stat.infofont, str(f"reroll price: {chrinfo[6]}"), Stat.txt_color, screen, width+10, height+170)
    draw_txt(Stat.infofont, str(f"expense scaling: {chrinfo[2]}"), Stat.txt_color, screen, width+10, height+220)
...
from Services.finance import stockcreator as stcr
...
from Services.ending_screen_op import endinginit as endinit
from Repositories import database_op as data_op

from Services.day_change_op import daychange
...
from UI.inputs import endinputs

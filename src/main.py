...
def run(listofthings):
    ...
    while loop:
        ...
        if shopswitch.take:
            ...
            inputs.inputters(owned, stocks, wholefinance, shopswitch, dayswitch)
        ...
        if 30-timedifference/1000<=0 or dayswitch.take:
            ...
            if wholefinance.exp>wholefinance.money:
                break
            summarylist=daychange.daychange(stocks, wholefinance, owned, timer)
            ...
            while summaryloop:
                summaryloop=daychange.summary_driver(screen, summary, wholefinance, summaryloop)
                pygame.display.update()
...
def starting_screen():
    ...
    while loop:
        ...
        draw_no.draw_txt(startfont, "start", "white", screen, screen_width/2-75, screen_height/2-50) 
        pygame.display.update()
starting_screen()
